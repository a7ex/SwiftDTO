...
public struct ObjType: JSOBJSerializable, DictionaryConvertible, CustomStringConvertible {
    ...
    public init?(jsonData: JSOBJ?) {
        ...
        #if DEBUG
            DTODiagnostics.analize(jsonData: jsonData, expectedKeys: allExpectedKeys, inClassWithName: "ObjType")
        #endif
    }
