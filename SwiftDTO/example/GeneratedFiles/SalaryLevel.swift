...
public struct SalaryLevel: JSOBJSerializable, DictionaryConvertible, CustomStringConvertible {
    ...
    public init?(jsonData: JSOBJ?) {
        ...
        #if DEBUG
            DTODiagnostics.analize(jsonData: jsonData, expectedKeys: allExpectedKeys, inClassWithName: "SalaryLevel")
        #endif
    }
