...
open class defaultRequest: JSOBJSerializable, DictionaryConvertible, CustomStringConvertible {
    ...
    public init?(jsonData: JSOBJ?) {
        ...
        #if DEBUG
            DTODiagnostics.analize(jsonData: jsonData, expectedKeys: allExpectedKeys, inClassWithName: "defaultRequest")
        #endif
    }
