...
public struct AgeGroup: JSOBJSerializable, DictionaryConvertible, CustomStringConvertible {
    ...
    public init?(jsonData: JSOBJ?) {
        ...
        #if DEBUG
            DTODiagnostics.analize(jsonData: jsonData, expectedKeys: allExpectedKeys, inClassWithName: "AgeGroup")
        #endif
    }
